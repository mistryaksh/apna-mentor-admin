...
import { useLazyGetMentorByIdQuery, useLazyGetAllCategoryQuery, useLazyGetAllSubCategoryQuery, useUpdateMentorByIdMutation } from "../../../../app/api";
...
export const MentorDetailsPage = () => {
     ...
     const [UpdateMentor, { isLoading: isMentorUpdateLoading, isError: isMentorUpdateError, error: mentorUpdateError }] = useUpdateMentorByIdMutation();
     ...
     }, [mentorId, isMentorError, mentorError, GetMentor, GetAllCategory, GetAllSubCategory, isCategoryError, categoryError, isError, error, isMentorUpdateError, mentorUpdateError]);
     ...
     return (
          <Layout pageTitle={`${mentor?.data.name.firstName} ${mentor?.data.name.lastName} details`}>
               ...
               {!isMentorLoading && !isCategoryLoading && !isMentorUpdateLoading && (
                    <div>
                    ...
                    <Formik
                         ...
                         initialValues={{
                              ...
                              ...mentor?.data.contact,
                              ...mentor?.data.auth,
                              category: mentor?.data.category?._id,
                              subCategory: mentor?.data.subCategory.find((subCategory) => mentor?.data.category?._id === subCategory.categoryId)?._id as string,
                         }}
                         enableReinitialize
