...
import { AiOutlineMail, AiOutlinePhone, AiOutlineVerified } from "react-icons/ai";
...
export const UserDetailsPage = () => {
     ...
     const [GetUser, { data: userData, isError: isUserError, error: userError, isFetching }] =
               ...
               <div className="h-[80vh]  flex justify-center items-center mt-10">
                    <div className="w-[70%] rounded-lg shadow-lg border p-3">
                         ...
                         <div className="mt-5 flex flex-col gap-3" id="contact">
                              <label htmlFor="contact" className=" font-mono text-gray-500 uppercase">
                                   Contact details
                              </label>
                              <div>
