...
export const VideoCallsPage = () => {
     const { data: calls, isError: isCallsError, isFetching: isCallLoading, error: callError } = useGetAllCallsQuery();
          ...
          <Layout pageTitle="Website call logs">
                    ...
                    <Table
                         ...
                         columns={[
                              ...
                              },
                              {
                                   ...
                                   selector: ({ users }) => users.mentor.name.firstName,
                                   cell: ({ users }) => (
                                        <p className="uppercase text-gray-500">{users.mentor.category.title}</p>
                                   ),
                              },
                              {
                              ...
                              },
                              {
                                   ...
                                   cell: ({ message }) => <p className="lowercase text-gray-500">{message.length}</p>,
                              },
                              {
                                   id: "status",
                                   name: "status",
               ...
               {isCallLoading && (
                    <div className="h-[300px] flex flex-col justify-center gap-5 items-center">
                         <AiOutlineLoading3Quarters size={150} className="animate-spin text-primary-500" />
                         <p className="uppercase text-gray-500 animate-pulse">Getting call lists....</p>
                    </div>
               )}
               {calls?.data.length === 0 && (
                    <div>
